...
import com.tdd.blog.website.modal.Vo.AttachVo;
import com.tdd.blog.website.modal.Vo.UserVo;
import com.tdd.blog.website.service.IAttachService;
import com.tdd.blog.website.service.ILogService;
import com.tdd.blog.website.utils.Commons;
...
public class AttachController extends BaseController {
    ...
    public RestResponseBo delete(@RequestParam Integer id, HttpServletRequest request) {
        try {
            ...
            if (null == attach) return RestResponseBo.failMsg("不存在该附件");
